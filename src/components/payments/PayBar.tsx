...
export default function PayBar({data}: PayBarProps) {
    ...
    <>
      ...
      <div className="w-full flex flex-row justify-center items-start gap-3 p-2">
        <div className="flex flex-row justify-center items-center gap-2">
          ...
          <p className="text-xs text-gray-500 font-light">Cuentas Cobradas: <span className="font-bold">{data.paid}</span></p>
        </div>

        <div className="flex flex-row justify-center items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-red-600"></div>
          <p className="text-xs text-gray-500 font-light">Cuentas por Cobrar: <span className="font-bold">{data.pending}</span></p>
        </div>
      </div>
    </>
  )
