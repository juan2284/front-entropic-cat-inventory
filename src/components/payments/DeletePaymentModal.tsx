...
export default function DeletePaymentModal({state, dispatch}: DeletePaymentModalProps) {
  ...
  const handleDelete = () => {
    mutate(state.paymentDetails._id);
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full rounded-sm max-w-4xl transform overflow-hidden bg-white text-left align-middle shadow-xl transition-all p-2">
                  ...
                  >Eliminar Transacción</Dialog.Title>

                  <h4 className="text-center">Por favor, confirme si desea eliminar esta Transacción:</h4>

                  <PaymentsTable state={state!} payments={[state.paymentDetails]} dispatch={dispatch} />
