...
export default function DeleteUserModal({state, dispatch}: DeleteUserModalProps) {
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full rounded-sm max-w-4xl transform overflow-hidden bg-white text-left align-middle shadow-xl transition-all p-2">
                  ...
                  <UsersTable state={state!} users={[state.userDetails]} dispatch={dispatch} />
